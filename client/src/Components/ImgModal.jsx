...
const ImgModal = ({ imgData }) => {
    ...
    return (
        <div className="flex flex-col w-full h-full items-center justify- gap-5">
            ...
            <button className="bg-customBlue text-slate-100 w-fit text-3xl m-5 px-12 py-3 rounded-xl hover:bg-opacity-60 ">
                <a href={imgData.pageURL} target="_blank" rel="noreferrer">
                    Link to page
                </a>
            </button>
        </div>
